var hikeDocID = localStorage.getItem("hikeDocID");  // Visible to all functions that's on this page

// Gets the hike name and replaces the "Hike Name" html text with the actual hike name.
